<# 
   .SYNOPSIS 
    Checks size of ConfigMgr client cache

   .DESCRIPTION
    Checks that the current size of the ConfigMgr client cache is still correct 
...
if( $CCMClientCacheSize -eq $NewCCMClientCacheSize)
{
    $Compliance = "Compliant"
}
else
